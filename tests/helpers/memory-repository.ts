...
export const TABLE_NAMES:TableName[]=['animationChallenges','animationChallengeVersions','users','problems','testCases','builds','buildVersions','workflowNodes','workflowEdges','skills','tools','buildSkills','buildTools','runs','runCases','submissions','credentials','failureCases','reputations','badges','userBadges','forkRelations','components','componentVersions','attachments','componentAttachmentContents','componentTestSuites','componentTestSuiteVersions','componentTestRuns','publicationRequests','publicationReviews','componentReleases','usageReferences','extensionApplications','communityAuditEvents','evaluationJobs','evaluationAttempts','evaluationInvocations','evaluationUsageRecords','evaluationIdempotencyKeys','evaluationBudgetReservations','evaluationOutbox','environmentTemplates','environmentTemplateVersions','creationBriefs','creationBriefVersions','creationRuns','artifactBundles','artifacts','workPublications','workLikes','showcaseEntries','showcaseBallots','showcaseVotes','showcaseAuditEvents'];
