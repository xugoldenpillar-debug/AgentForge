...
const buttonVariants=cva('button',{variants:{variant:{default:'primary',secondary:'',outline:'outline',ghost:'ghost',destructive:'danger'},size:{default:'',sm:'small',lg:'large',icon:'icon'}},defaultVariants:{variant:'secondary',size:'default'}});
